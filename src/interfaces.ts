...
export interface UsePlayers {
  ...
  subtractPlayerPoints: (id: number, points: number) => void
}
...
export interface UseGame {
  ...
  setMemo: (memo: number[]) => void
  addMemo: (score: number) => void
  resetMemo: () => void
  getLatestMemo: () => number
}
